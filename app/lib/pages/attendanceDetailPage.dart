            ...
            appBar: AppBar(
              ...
              title: Row(
                children: <Widget>[
                  ...
                  SizedBox(width: 10.0),
                  Text('Attendance For '+widget.rowData['dateLabel'].toString(),
                      style: TextStyle(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: <Widget>[
                          rowSummerData(lang.tr("Absent"),widget.rowData['ABSENT'].toString()),
                          rowSummerData(lang.tr("Permission"),widget.rowData['PERMISSION'].toString()),
                          rowSummerData(lang.tr("Late"),widget.rowData['LATE'].toString()),
                          rowSummerData(lang.tr("Early Leave"),widget.rowData['EarlyLeave'].toString()),
