                        ...
                        Container(
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                rowStudentData(lang.tr("POB"),rsProfileList[0]['pob'].toString()),
                                ...
                                rowStudentData(lang.tr("TEL"), rsProfileList[0]['father_phone'].toString()),
                                rowStudentData(lang.tr("NATION"), rsProfileList[0]['fatherNation'].toString()),
                                rowStudentData(lang.tr("JOB"), rsProfileList[0]['fatherOccupation'].toString()),
                                ...
                                rowStudentData(lang.tr("TEL"), rsProfileList[0]['mother_phone'].toString()),
                                rowStudentData(lang.tr("NATION"), rsProfileList[0]['motherNation'].toString()),
                                rowStudentData(lang.tr("JOB"), rsProfileList[0]['motherOccupation'].toString()),
                                ...
                                rowStudentData(lang.tr("TEL"),rsProfileList[0]['guardian_tel'].toString()),
                                rowStudentData(lang.tr("NATION"),rsProfileList[0]['guardianNation'].toString()),
                                rowStudentData(lang.tr("JOB"), rsProfileList[0]['guardian_job'].toString())                              ],
                            )
                        )
                      ],
                    ),
...
//                    color: Colors.lightBlue.withOpacity(0.5),
  ...
  _getJsonProfile() async{
   // final String urlApi = "http://jsonplaceholder.typicode.com/albums/1";
    ...
    if(rawData.statusCode==200){
      setState((){
        if(json.decode(rawData.body)['code']=='SUCCESS'){
          ...
          //debugPrint(rsProfileList.toString());
          isLoading = false;
        }
      });
    }
