...
class SchedulePage extends StatefulWidget {
  ...
  SchedulePage({this.studentId,this.currentLang});
  @override
          ...
          children: <Widget>[
            ...
            Expanded(
              child: Column(
                  ...
                  children:[
                    _rowScheduleList(Icon(Icons.featured_play_list,color:Colors.black.withOpacity(0.7),size: 20.0,),lang.tr('Subject'),(scheduleData['subject_name'].toString())!='null'?scheduleData['subject_name']:"N/A"),
                    _rowScheduleList(Icon(Icons.person_pin,color:Colors.black.withOpacity(0.7),size: 20.0,),lang.tr('Teacher'),(scheduleData['teacher_name'].toString())!='null'?scheduleData['teacher_name']:"N/A")
                  ]
              ),)
          ],
        )
