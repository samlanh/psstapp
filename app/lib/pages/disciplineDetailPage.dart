...
class DisciplineDetailPage extends StatefulWidget {
  ...
  DisciplineDetailPage({this.studentId,this.currentLang,this.currentMonth,this.groupId,this.rowData});
  @override
...
class _DisciplineDetailPageState extends State<DisciplineDetailPage> {
            ...
            appBar: AppBar(
              ...
              title: Row(
                children: <Widget>[
                  ...
                  SizedBox(width: 10.0),
                  Text('Discipline For '+widget.rowData['dateLabel'],
                      style: TextStyle(
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    rowSummerData(lang.tr('Minor'),widget.rowData['Minor'].toString()),
                    rowSummerData(lang.tr('Moderate'),widget.rowData['MODERATE'].toString()),
                    rowSummerData(lang.tr('Major'),widget.rowData['MAJOR'].toString()),
                    rowSummerData(lang.tr('Other'),widget.rowData['OTHER'].toString()),
                    Text(lang.tr('Total')+" "+widget.rowData['TOTAL_ATTRECORD'].toString(),style: TextStyle(fontSize:18.0,color: Colors.white,fontWeight: FontWeight.bold)),
                  ],
                ),
              ),
            )
  ...
  Widget rowSummerData(String strLabel,String strData){
    return Row(
      ...
      children: <Widget>[
        Expanded(
          child: Text(strLabel,style: TextStyle(color: Colors.white,fontSize: 12.0,fontWeight: FontWeight.bold)),
        ),
        Expanded(
        ...
        child: Row(
              ...
              children: <Widget>[
                Container(
                    ...
                    child: rowTitleDiscipline(lang.tr(rowData['attendenceStatusTitle']),rowData['dateAttendence'],35.0),
                ),
                Expanded(
                    child: Padding(padding: EdgeInsets.only(left: 5.0),
                        child: Column(
                            ...
                            mainAxisAlignment: MainAxisAlignment.start,
                            children:[
                              rowDisciplince(lang.tr('Reason'),'',14.0),
  ...
  Widget rowDisciplince(String textData, String priceData,double fontSize){
    return new Container(
      decoration: BoxDecoration(
