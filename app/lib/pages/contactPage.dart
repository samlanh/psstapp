              ...
              child:  Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    aboutVission(Icon(Icons.visibility,color: Colors.green,size: 30.0,),"Version"),
                    aboutVission(Icon(Icons.supervised_user_circle,color: Colors.green,size: 30.0,),"Mission"),
      ...
      children: <Widget>[
        ...
        Expanded(
          child: Container(
            ...
            decoration: BoxDecoration(
                border: Border(left: BorderSide(color: Color(0xff054798),width: 3.0))
            ),
            child: Column(
              children: <Widget>[
