...
class PaymentPage extends StatefulWidget {
  ...
  PaymentPage({this.studentId,this.currentLang});
  @override
...
//           border: Border(
//            right: BorderSide(width: 1.0, color: Color(0xffe4e6e8)),
//            top: BorderSide(width: 1.0, color: Color(0xffe4e6e8)),
//            bottom: BorderSide(width: 2.0, color: Color(0xff07548f)),
//            left: BorderSide(width: 1.0, color: Color(0xffe4e6e8)),
//
//          ),
                    ...
                    child: Container(
                        ...
                        child: Column(
                            ...
                            children:[
                              ...
                              _rowPayment(lang.tr('Penalty'),rowPayment['penalty'],12.0),
                              _rowPayment(lang.tr('T.Payment'),rowPayment['totalPayment'],12.0),
